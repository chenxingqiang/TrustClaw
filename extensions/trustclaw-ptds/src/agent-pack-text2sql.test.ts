...
import { loadPtdsSchemaSnippetForObjects } from "../../../trustclaw/runtime/text2sql/schema-context.js";
...
describe("agent pack Text2SQL prompts", () => {
  it("loads pack-specific templates and schema subsets", () => {
    ...
    const schema = loadPtdsSchemaSnippetForObjects(compliance!.data.readTables);
